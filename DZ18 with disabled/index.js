...
input_name.onclick = function() {
    !input_name.value ? submit_btn.setAttribute('disabled', 'disabled') : submit_btn.removeAttribute('disabled');
}

input_surname.onclick = function() {
    !input_surname.value ? submit_btn.setAttribute('disabled', 'disabled') : submit_btn.removeAttribute('disabled');
}

input_password.onclick = function() {
    !input_password.value ? submit_btn.setAttribute('disabled', 'disabled') : submit_btn.removeAttribute('disabled');
}

input_password2.onclick = function() {
    !input_password2.value ? submit_btn.setAttribute('disabled', 'disabled') : submit_btn.removeAttribute('disabled');
}
